...
My team at Etsy was in the early stages of [rebuilding one of Etsy sellers’ core management tools](/etsy-listings-manager), the listings manager. In addition to rebuilding the web app from the ground up, the early designers on the team, [Aaron Shapiro](http://www.aaron.mn) and [Diana Mounter](http://broccolini.net), also saw this rewrite as an opportunity to experiment with a new way of writing CSS. When I joined, the in-progress rewrite of the listings manager was using a brand new, fully responsive set of centralized CSS classes that Aaron and Diana had written. I eagerly joined in on their efforts to develop a CSS style guide for the listings manager. Little did we know that two years later, this style guide would exist on every page of Etsy and become *the* go-to way of writing front-end at the company.
