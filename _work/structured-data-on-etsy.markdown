...
When we announced the launch of Etsy Studio, we also announced that attributes were coming to listings to power search on Etsy Studio and eventually Etsy, and released the launch tool. Sellers had a period of time to update their listings before the public launch of Etsy Studio. 
